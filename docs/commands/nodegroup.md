...
| Flag | Description |
|---|---|
| `--cluster, -c` | EKS cluster name or partial pattern (overrides the active context and kubeconfig; env `EKS_CLUSTER_NAME`). See [cluster resolution](../concepts/configuration.md#cluster-resolution) |
